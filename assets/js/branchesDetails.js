...
document.addEventListener('DOMContentLoaded', function () {
    const app = {
        ...
        // mostrar/ocultar control de radio según el tipo de zona
        ...
        setupDeleteButtons: function () {
            const deleteButtons = document.querySelector('.delete-branch-btn');

            deleteButtons.addEventListener('click', (event) => {
                    event.stopPropagation();
                    Dialog("Eliminar Sucursal",
                        `Quiere eliminar la sucursal "${app.data.branchId}"?`,
        ...
        setupEditButtons: function () {
            const editButtons = document.querySelector('.edit-branch-btn');

            editButtons.addEventListener('click', (event) => {
                    event.stopPropagation();
                    // redirigir al formulario de edición
                    window.location.href = `./branchesFormEdit.html?Id=${app.data.branchId}`;
                });
        ...
        refreshData: function () {
            // deshabilitar boton y mostrar animación
